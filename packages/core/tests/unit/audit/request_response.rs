...
#[test]
fn push_log_request_preserves_typed_table_name_from_response() {
...
#[test]
fn push_log_request_deserializes_table_name_from_snake_case() {
...
#[test]
fn log_response_preserves_typed_table_name_from_model() {
