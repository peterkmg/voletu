...
interface BlendingMutateDrawerProps {
  open: boolean
  onOpenChange: (open: boolean) => void
  currentRow?: BlendingResponse | null
}

export function BlendingMutateDrawer({
  open,
  onOpenChange,
  currentRow,
}: BlendingMutateDrawerProps) {
    ...
    >
      <SheetContent className="flex flex-col">
        ...
        <Form {...form}>
          ...
          >
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t('documents:items.product')}</FormLabel>
                  <FormControl>
                    <Input {...field} />
                  </FormControl>
                  <FormMessage />
        ...
        <SheetFooter className="gap-2">
          ...
          <Button form="blending-form" type="submit">
