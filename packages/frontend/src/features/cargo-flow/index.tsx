...
function useCargoFlowData(): { data: CargoFlowRow[], isLoading: boolean } {
  ...
  const directDispatch = useDispatchDocumentQuery({ dispatchMethod: 'VESSEL_TERMINAL' as any, dispatchPurpose: 'EXTERNAL' as any })
  const bunkering = useDispatchDocumentQuery({ dispatchMethod: 'BUNKERING' as any })
  const blending = useBlendingDocumentList()
