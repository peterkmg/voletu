      ...
      actions={[
        {
          ...
          icon: ChevronRight,
          inline: true,
          onClick: () => navigate({ to: `/incoming/rail/${targetId}` }),
        },
      ]}
    />
  )
  ...
  if (acceptanceQuery.data?.data) {
    ...
    return (
      <DocumentDetailPage
        ...
        itemsContent={
          <ChildItemsTable items={doc.items} columns={[
          ...
          ]} isLocked={doc.status === 'POSTED'} sectionTitle="Acceptance Items" />
        }
    ...
    return (
      <div className="mx-auto max-w-4xl space-y-6 p-4">
        <div className="flex items-center gap-3">
          <h1 className="text-lg font-semibold">Rail Waybill <span className="text-muted-foreground">{wb.documentNumber}</span></h1>
