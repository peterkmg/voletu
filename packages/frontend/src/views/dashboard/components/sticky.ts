...
export const EDGE_SHADOW = {
  stickyLeft: '2px 0 4px -2px hsl(var(--border))',
  stickyRight: '-2px 0 4px -2px hsl(var(--border))',
  stickyBottom: '0 -2px 4px -2px hsl(var(--border))',
  stickyBottomLeft: '2px -2px 4px -2px hsl(var(--border))',
  stickyBottomRight: '-2px -2px 4px -2px hsl(var(--border))',
} as const
