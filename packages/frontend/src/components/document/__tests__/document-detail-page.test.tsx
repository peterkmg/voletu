...
describe('documentDetailPage', () => {
  it('renders detail views without lifecycle controls when no document actions are provided', () => {
    ...
    expect(screen.queryByRole('button', { name: 'common:actions.execute' })).not.toBeInTheDocument()
    expect(screen.queryByRole('button', { name: 'common:actions.revert' })).not.toBeInTheDocument()
  })
})
