...
export function defineViewRoute<TPath extends FileRoutePath>(path: TPath): ReturnType<typeof createFileRoute<TPath>>
export function defineViewRoute<TPath extends FileRoutePath>(
