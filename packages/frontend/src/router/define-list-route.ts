...
export function defineListRoute<TPath extends FileRoutePath>(path: TPath): ReturnType<typeof createFileRoute<TPath>>
export function defineListRoute<TPath extends FileRoutePath>(
