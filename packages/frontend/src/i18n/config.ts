...
import bunkeringEn from './locales/en/bunkering.json'
...
import bunkeringRu from './locales/ru/bunkering.json'
...
import tablesRu from './locales/ru/tables.json'
...
i18n.use(initReactI18next).init({
  ...
  fallbackLng: 'en',
  ns: ['common', 'entities', 'tables', 'catalog', 'documents', 'transport', 'system', 'auth', 'dashboard', 'forms', 'acceptance', 'truck-receipt', 'rail-receipt', 'physical-transfer', 'ownership-transfer', 'truck-dispatch', 'direct-dispatch', 'blending', 'bunkering', 'reconciliation'],
  defaultNS: 'common',
  interpolation: {
    escapeValue: false,
  },
